                ...
                @for ($k=0; $k<count($halved); $k++) <div class="col-md-6">
                    ...
                    <div class="card mb-2">
                        <div class="card-body">
                            <div class="row h-100">
                                <div class="col">
                                    <span style="font-size: 16px;" display="inline-block;">{{$r->Name}}
                            ...
                            <!--<div class="rating" id ="rating{{$r->ISBN}}{{$r->Email}}">
                                <div id="rating-Edit{{$r->ISBN}}{{$r->Email}}" class="rating-upper" style="width: 0%; font-size: 20px;">
                                    @for ($i=1; $i<6; $i++) <input onclick="" style="display:none;" class="checkbox" id="star{{$i}}" type="radio" name="ratingEdit" value="{{$i}}">
                                        <label for="star{{$i}}">★</label>
                                        @endfor
                                </div>
                                <div class="rating-lower" style="font-size: 20px;">
                                    @for ($i=1; $i<6; $i++) <input style="display:none;" class="checkbox" id="star{{$i}}" type="radio" name="ratingEdit" value="{{$i}}">
                                        <label for="star{{$i}}">★</label>
                                        @endfor
                                </div>
                            </div>-->
                            ...
                            <div style="float: right">
                                <button id="edit" class="btn btn-sm btn-primary" style="width:100px;" onclick="editReview('{{$r->ISBN}}{{$r->Email}}');">
                                    Edit
                                    <svg width="14px" height="14px" style="fill: white;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                ...
                                <form action="{{ route('deleteReview', ['isbn' => $r->ISBN]) }}" method="post">
                                    @csrf
                                    <button id="edit" class="btn btn-sm btn-primary" style="width:100px;" type="submit">
                                        Delete
                                        <svg width="14px" height="14px" style="fill: white;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                            <!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
                                            <path d="M490.3 40.4C512.2 62.27 512.2 97.73 490.3 119.6L460.3 149.7L362.3 51.72L392.4 21.66C414.3-.2135 449.7-.2135 471.6 21.66L490.3 40.4zM172.4 241.7L339.7 74.34L437.7 172.3L270.3 339.6C264.2 345.8 256.7 350.4 248.4 353.2L159.6 382.8C150.1 385.6 141.5 383.4 135 376.1C128.6 370.5 126.4 361 129.2 352.4L158.8 263.6C161.6 255.3 166.2 247.8 172.4 241.7V241.7zM192 63.1C209.7 63.1 224 78.33 224 95.1C224 113.7 209.7 127.1 192 127.1H96C78.33 127.1 64 142.3 64 159.1V416C64 433.7 78.33 448 96 448H352C369.7 448 384 433.7 384 416V319.1C384 302.3 398.3 287.1 416 287.1C433.7 287.1 448 302.3 448 319.1V416C448 469 405 512 352 512H96C42.98 512 0 469 0 416V159.1C0 106.1 42.98 63.1 96 63.1H192z" />
