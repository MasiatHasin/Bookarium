...
function checkbox2(id) {
    if (document.getElementById(id + 'plus').style.display == "none") {
        document.getElementById(id + 'plus').style.display = "block";
        document.getElementById(id).value = "plus";
        document.getElementById(id + 'box').style.backgroundColor = "#7FB5FF";
        document.getElementById(id + 'box').style.borderColor = "#7FB5FF";
...
function selectYear(year) {
    if (document.getElementById('year').value == year) {
        ...
        document.getElementById('year' + year).style.backgroundColor = 'white';

    }
    else {
        prevYear = document.getElementById('year').value;
        document.getElementById('year' + prevYear).style.backgroundColor = 'white';
        document.getElementById('year').value = year;
        document.getElementById('year' + year).style.backgroundColor = "#7FB5FF";
    }
}

//Advanced search filter by rating display
function rate(rating) {
    if (document.getElementById('rating').value == rating){
        rating = 0;
